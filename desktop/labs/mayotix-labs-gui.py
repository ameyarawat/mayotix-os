...
def build_gtk_app():
    ...
    class LabsWindow(Gtk.Window):
        ...
        def create_sandbox_tab(self, Gtk):
            ...
            btn_launch_kvm = Gtk.Button(label="Launch KVM Micro-VM")
            btn_snap_kvm = Gtk.Button(label="QCOW2 Snapshot")
            ...
            btn_box.pack_start(btn_launch_kvm, False, False, 0)
            btn_box.pack_start(btn_snap_kvm, False, False, 0)
        ...
        def create_reports_tab(self, Gtk):
            ...
            btn_deploy_top = Gtk.Button(label="Deploy Lab Topology")
            btn_teardown_top = Gtk.Button(label="Teardown Topology")

            btn_box.pack_start(btn_refresh_rep, False, False, 0)
            btn_box.pack_start(btn_triage, False, False, 0)
            btn_box.pack_start(btn_deploy_top, False, False, 0)
            btn_box.pack_start(btn_teardown_top, False, False, 0)
            box.pack_start(btn_box, False, False, 5)
