...
# ==============================================================================
# MAYOTIX OS — Live ISO Kickstart for livemedia-creator
# Auto-generated by scripts/build-iso.sh
# NOTE: Do NOT use text/cmdline/graphical — livemedia-creator controls display.
# NOTE: Must use url/nfs/ostreesetup as install method.
# NOTE: Partitioning is for the temporary build image, not the final install.
# ==============================================================================

# Install source — Fedora package repository
